...
namespace MiliNeu.Areas.Identity.Pages.Account
{
    ...
    public class ResendEmailConfirmationModel : PageModel
    {
        ...
        public ResendEmailConfirmationModel(UserManager<ApplicationUser> userManager, IEmailSender emailSender, ISendGridService sendGridService)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            await _SendgridService.SendEmailAsync("DevUser", email, subject, message);
